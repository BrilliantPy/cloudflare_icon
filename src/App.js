...
function App() {
  ...
  const [icons,setExportIcon] = useState(initData)
  const [modes,setMode] = useState('react')

  const copytoClipboard = (e)=>{
    // navigator.clipboard.writeText(e)
    setExportIcon(e)
    // return alert("Copied icon name is : "+e)
  }

  const getFullCode = (e)=>{
    const fullCode = `<i className="fa `+e+` fa-fw"></i>`
    return fullCode
  }
          ...
          <div className="row">
            <div className="col-md-2">
              <div className='radioMode'>
                <div className='modeLeft'><b>Mode: </b>
              ...
              <div className="codeContainer">
                <code id="fullCode">{getFullCode(icons)}</code>
              </div>
            </div>
            <div className="col-md-10">
              <ul>
                {data.map(e => {  
                  ...
                  return (<li className='groupContent'><button className='btn btn-outline-primary hoverZoom' onClick={()=>copytoClipboard(e)} title={e}><i className={fullClassName}></i></button></li>)
                })}  
              </ul>
            </div>
          </div>
      </div>
      <footer class="bp-center bp-margin-top">
